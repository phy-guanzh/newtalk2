...
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/SMP-RunIISummer20UL18wmLHEGEN-00236_1_cfg.py . || exit_on_error $? 150 "Could not download sandbox1."
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/SMP-RunIISummer20UL18SIM-00091_1_cfg.py . || exit_on_error $? 150 "Could not download sandbox1."
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/SMP-RunIISummer20UL18DIGIPremix-00091_1_cfg.py . || exit_on_error $? 150 "Could not download sandbox1."
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/SMP-RunIISummer20UL18HLT-00091_1_cfg.py . || exit_on_error $? 150 "Could not download sandbox1."
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/SMP-RunIISummer20UL18RECO-00091_1_cfg.py . || exit_on_error $? 150 "Could not download sandbox1."
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/SMP-RunIISummer20UL18MiniAODv2-00093_1_cfg.py . || exit_on_error $? 150 "Could not download sandbox1."
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/SMP-RunIISummer20UL18NanoAODv9-00092_1_cfg.py . || exit_on_error $? 150 "Could not download sandbox1."
#cmsrel CMSSW_10_2_18
#cd CMSSW_10_2_18/src
#cmsenv
#cd -
# Download sandbox, replace it when you have different sandbox_name
sandbox_name1="sandbox-CMSSW_10_6_22-e04f4b6.tar.bz2"  #LHEGen
sandbox_name2="sandbox-CMSSW_10_6_17_patch1-a59e098.tar.bz2" #SIM
sandbox_name3="sandbox-CMSSW_10_6_17_patch1-a59e098.tar.bz2" #DIGI
sandbox_name4="sandbox-CMSSW_10_2_16_UL-bea37ee.tar.bz2" #HLT
sandbox_name5="sandbox-CMSSW_10_6_17_patch1-a59e098.tar.bz2" #RECO
sandbox_name6="sandbox-CMSSW_10_6_20-bff0fce.tar.bz2" #MINIAOD2
sandbox_name7="sandbox-CMSSW_10_6_26-83d01aa.tar.bz2" #NANO
...
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/${sandbox_name1} . || exit_on_error $? 150 "Could not download sandbox1."
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/${sandbox_name2} . || exit_on_error $? 150 "Could not download sandbox1."
#xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/${sandbox_name3} . || exit_on_error $? 150 "Could not download sandbox1."
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/${sandbox_name4} . || exit_on_error $? 150 "Could not download sandbox1."
#xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/${sandbox_name5} . || exit_on_error $? 150 "Could not download sandbox1."
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/${sandbox_name6} . || exit_on_error $? 150 "Could not download sandbox1."
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/pyfile2018/${sandbox_name7} . || exit_on_error $? 150 "Could not download sandbox1."
