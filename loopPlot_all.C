...
void loopPlot(int isBarrel,TString isChannel) {
	...
	vector<TString> pathToTrees = {"../Common/rootfiles/","../Common/rootfiles/","../Common/rootfiles/"};
	std::string outputDir = "./fig-output_all/";
	RoccoR  rc;
...
//		continue;
	...
	EDBRHistoPlotter *plotter = new EDBRHistoPlotter("./", fHistosData,
			fHistosMC, fHistosMCSig, 138, scaleToData, scaleOnlyWJets,
