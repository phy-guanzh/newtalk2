...
sandbox_name1="sandbox-CMSSW_10_6_22-a9ec907.tar.bz2"
sandbox_name2="sandbox-CMSSW_10_6_17_patch1-2be13ee.tar.bz2"
sandbox_name4="sandbox-CMSSW_10_6_25-38d2c87.tar.bz2"
sandbox_name5="sandbox-CMSSW_10_6_26-552d939.tar.bz2"
sandbox_name3="sandbox-CMSSW_8_0_33_UL-5f0516c.tar.bz2"


xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/hgamma/20162/${sandbox_name1} . || exit_on_error $? 150 "Could not download sandbox1."
...
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/hgamma/20162/${sandbox_name3} . || exit_on_error $? 150 "Could not download sandbox1."
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/hgamma/20162/${sandbox_name4} . || exit_on_error $? 150 "Could not download sandbox1."
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/hgamma/20162/${sandbox_name5} . || exit_on_error $? 150 "Could not download sandbox1."
...
xrdcp root://eosuser.cern.ch//eos/user/z/zguan/www/WWA_gridpack/hgamma/20162/pyfile.tar.gz . || exit_on_error $? 150 "Could not download sandbox1."
